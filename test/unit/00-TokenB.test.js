...
const tokenName = token2Config.name;
const symbol = token2Config.symbol;
const initialSupply = token2Config.initialSupply;
const decimals = token2Config.decimals;
...
!developmentChains.includes(network.name)
  ...
  : describe("Token Unit Tests", function () {
      beforeEach(async () => {
        ...
        tokenContract = await ethers.getContract("TokenB");
